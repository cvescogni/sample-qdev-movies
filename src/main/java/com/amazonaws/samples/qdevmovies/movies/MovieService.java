...
public class MovieService {
     ...
     * This method be the treasure map to find yer favorite films.
     * 
    ...
    public List<Movie> searchMovies(String name, Long id, String genre) {
        logger.info("Ahoy! Searching for treasure... er, movies with criteria - name: {}, id: {}, genre: {}", 
                   name, id, genre);
        ...
        logger.info("Found {} movies matching the search criteria, ye landlubber!", searchResults.size());
        return searchResults;
    }

    /**
     * Gets all available genres from the movie treasure chest
     * 
